...
CONSTRAINTS_NAME = "Domain-Divided_Constraints_1_[1, 3, 5, 7, 9]"
OUTPUT_NAME = "Domain-Divided_cABN_[1, 3, 5, 7, 9]"

STORAGE_PATH = Path(rf"C:\Users\Lithi\OneDrive\שולחן העבודה\Alpha Research\Programs\Model Translator\cABN Storage\{TYPE}")
